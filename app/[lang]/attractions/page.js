...
export async function generateMetadata({ params }) {
  ...
  return {
    title: lang === 'fr'
      ? "Toutes les attractions — J'aime le Québec"
      : "All attractions — J'aime le Québec",
  }
}
...
export default async function AttractionsPage({ params, searchParams }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <FilterBar lang={lang} t={t} filtres={filtres} currentRegion={sp?.region} currentCategorie={sp?.categorie} />
