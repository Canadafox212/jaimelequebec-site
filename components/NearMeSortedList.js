...
function getCategoryGradient(category) {
  ...
  if (c.includes('parc') || c.includes('nature') || c.includes('national')) return 'bg-gradient-to-br from-emerald-700 to-emerald-900'
  if (c.includes('histoire') || c.includes('heritage') || c.includes('patrimoine')) return 'bg-gradient-to-br from-amber-700 to-amber-900'
  if (c.includes('plein air') || c.includes('outdoor') || c.includes('sport')) return 'bg-gradient-to-br from-teal-600 to-teal-800'
  if (c.includes('croisière') || c.includes('cruise') || c.includes('marine')) return 'bg-gradient-to-br from-blue-600 to-blue-900'
  if (c.includes('village') || c.includes('quartier') || c.includes('district')) return 'bg-gradient-to-br from-rose-600 to-rose-900'
  if (c.includes('île') || c.includes('island') || c.includes('littoral')) return 'bg-gradient-to-br from-cyan-600 to-cyan-900'
  if (c.includes('faune') || c.includes('wildlife') || c.includes('zoo')) return 'bg-gradient-to-br from-green-600 to-green-900'
  if (c.includes('route') || c.includes('circuit')) return 'bg-gradient-to-br from-orange-600 to-orange-900'
  if (c.includes('divert') || c.includes('casino') || c.includes('entertain')) return 'bg-gradient-to-br from-purple-600 to-purple-900'
